...
{
    public partial class AddQurencyDealsforUserTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentsViewModel", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameDeal = table.Column<string>(nullable: true),
                    Explanation = table.Column<string>(nullable: true),
                    IdAuthor = table.Column<string>(nullable: true),
                    IdExecutor = table.Column<string>(nullable: true),
                    DataCreated = table.Column<DateTime>(nullable: false),
                    DataFinish = table.Column<DateTime>(nullable: false),
                    QurencySumma = table.Column<int>(nullable: false),
                    AcceptForAuthor = table.Column<bool>(nullable: false),
